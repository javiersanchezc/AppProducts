...
public class ControllerAdviceBase extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleNullOrderException(NullOrderException ex, HttpServletRequest request) {
        return buildProblemDetail(HttpStatus.BAD_REQUEST, ex.getMessage());
    }

    @ExceptionHandler(OrderCreationException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ProblemDetail handleOrderCreationException(OrderCreationException ex, HttpServletRequest request) {
